...
//Code Here
var evenNumbers  = mixedNumbers.filter(num => {
  if(num%2==0) {
    return num;
  }
});
...
//Code Here
var postTaxPrices = prices.map((num) => {
  var total = num * 1.07
  return total
});
...
//Code Here
var totalPopulation = populations.reduce((accumulator, arr) => {
...
//Code Here
var myStrongest  = monstersInYourPocket.filter((obj) => obj.CP>200);
...
var ordersTotal = orders.filter((obj) => {
  var total = obj.price + obj.tax;
  return total;
})
// let ordersTotal = orders.map(function(value) {
//   var price = value.price * value.tax;
//   return price;
// });
...
var bobsTotal = purchases.reduce((accumulator,curr) => {
  if(curr.owner==="Bob") {
